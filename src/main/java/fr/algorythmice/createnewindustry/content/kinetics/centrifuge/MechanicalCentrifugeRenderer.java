...
public class MechanicalCentrifugeRenderer extends KineticBlockEntityRenderer<MechanicalCentrifugeBlockEntity> {

    public MechanicalCentrifugeRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public boolean shouldRenderOffScreen(MechanicalCentrifugeBlockEntity be) {
        return true;
    }

    @Override
    protected void renderSafe(MechanicalCentrifugeBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
